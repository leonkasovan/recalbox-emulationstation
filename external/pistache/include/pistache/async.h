 ...
 */
        ...
        private:
            ...
            {
                promise.then(makeContinuation<T, Index>(data), [data](std::exception_ptr ptr) {
        ...
        struct WhenAllRange
        {
            ...
            void operator()(Iterator first, Iterator last)
            {
                ...
                for (auto it = first; it != last; ++it)
                {
                    ...
                    it->then(std::move(cont), [data](std::exception_ptr ptr) {
                        std::lock_guard<std::mutex> guard(data->mtx);
   ...
   */
    ...
    Promise<Results> whenAll(Iterator first, Iterator last)
    {
        ...
        return Promise<Results>([first, last](Resolver& resolve, Rejection& rejection) {
